...
import { FetchFoodsMenuRequest } from '../requests/FetchFoodsMenuRequest';

export const handler: APIGatewayProxyHandler = async (event) => {
    try {
        const query = FetchFoodsMenuRequest.transform(event);
        ...
        return {
            ...
            body: JSON.stringify({
                message: "Foods menu successfully fetched", 
                foods
            })
        };
